...
console.log(squareList(niz));
  ...
  //console.log(a%1===0)-ceo broj
  //(b%1!==0)-decimalan broj

  //Number.isInteger() metoda vraca boolean u zavisnosti od toga 
  //da li je argument date metode ceo broj ili nije.
const a=14;
const b=14.5
console.log(a%1===0)
console.log(b%1==0)
